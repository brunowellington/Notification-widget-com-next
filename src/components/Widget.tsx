        ...
        <div className="divide-y-2 divide-zinc-950">
          <div className="bg-zinc-900 px-8 py-4 flex items-start gap-6">
            ...
            <div className="flex-1 flex flex-col gap-2">
              <p className="text-sm leading-relaxed text-zinc-100">
                Estudando Next.js junto com Tailwind pelo curso da empresa
                Rockeseat.
              </p>
          ...
          <div className="bg-zinc-900 px-8 py-4 flex items-start gap-6">
            ...
            <div className="flex gap-2 self-center">
              ...
              <button className="w-8 h-8 rounded flex items-center justify-center bg-violet-500 hover:bg-zinc-600">
